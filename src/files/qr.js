...
function b(o, e) {
	...
	var w = (this.foregroundPadding = 0),
		...
		A = (this.typeNumberBackgroundColor = void 0),
								...
								if ('backgroundImage' === n.name) {
									...
									u < 2 * (c = Math.round(n.borderRadius)) && (c = u / 2),
										...
										c > 0 &&
											(r.beginPath(),
											r.moveTo(a + c, d),
											r.arcTo(a + u, d, a + u, d + g, c),
											r.arcTo(a + u, d + g, a, d + g, c),
											r.arcTo(a, d + g, a, d, c),
											r.arcTo(a, d, a + u, d, c),
											r.closePath(),
											r.setStrokeStyle('rgba(0,0,0,0)'),
											r.stroke(),
											r.clip());
									try {
									...
									p < 2 * k && (k = p / 2),
										...
										k > 0
											? (r.beginPath(),
											  r.moveTo(f + k, v),
											  r.arcTo(f + p, v, f + p, v + C, k),
											  r.arcTo(f + p, v + C, f, v + C, k),
											  r.arcTo(f, v + C, f, v, k),
											  r.arcTo(f, v, f + p, v, k),
											  r.closePath(),
