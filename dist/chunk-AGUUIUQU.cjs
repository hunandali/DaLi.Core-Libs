...
async function fingerprint() {
  if (_chunkU4AQ4RPTcjs.SERVERMODE) return { id: "server", score: 1 };
...
var dateFormat = (date2, format = "YYYY-MM-DD") => {
  if (_chunkU4AQ4RPTcjs.isEmpty.call(void 0, date2)) return "";
  if (_chunkU4AQ4RPTcjs.isString.call(void 0, date2)) date2 = date2.toLowerCase();
